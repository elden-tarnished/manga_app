 ...
 * @param {function} onClose - Called AFTER close animation completes
 * @param {string} title - Title text
 * @param {React.ReactNode | function} children - body content OR render function receiving { close }
 * @param {object=} animations - Optional GSAP templates for open/close
 */
